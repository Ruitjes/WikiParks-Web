	...
	<nav class="navbar navbar-inverse" style="border-radius: 0px; background-color: darkorange;">
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="myNavbar">
         ...
         <div id="park-finder">
			<div id="slogan"><li>Vindt de leukste en de dichtsbijzijnste pretparken!</li></div>	
			<div id="address-search">
				<input type="text" name="address" class="address" placeholder="bv. Janssenweg 73 / 5961 RM">
			</div>
			<div id="submit-button">
				<input type="submit" name="submit-button" value="Zoek!">
			</div>
		</div>
